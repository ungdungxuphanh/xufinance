...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-Bbb6Rjs3.js
var server_Bbb6Rjs3_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Be8Rvzw8.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Gk55i8hA.mjs").then((n) => n.t),
		import("./start-BDuoZy1d.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_Bbb6Rjs3_exports as t };
